...
def run_ihdp(data_base_dir='/Users/claudiashi/data/ihdp_csv', output_dir='~/result/ihdp/',
             ...
             ratio=1.,lr2 = 0.1,batchsize2 =16, dragon=''):
    ...
    for idx, simulation_file in enumerate(simulation_files):
        ...
        for is_targeted_regularization in [False]:
            ...
            test_outputs, train_output,net,train_dict,test_dict = train_and_predict_dragons(t_t, y_t, x_t,net,seed = idx,
                                                                   ...
                                                                   val_split=val_split,batch_size=batchsize2,lr = lr2)
    ...
    with open(f'./params_target{target_col_idx}/experiments_warm_{dragon}_{batchsize2}_{lr2}.json', 'w') as fp:
...
def turn_knob(data_base_dir='/Users/claudiashi/data/test/', knob='dragonnet',
    ...
    if knob == 'dragonnet':
        run_ihdp(data_base_dir=data_base_dir, output_dir=output_dir, dragon='dragonnet' ,lr2  = lr, batchsize2 = batchsize)

    if knob == 'tarnet':
        run_ihdp(data_base_dir=data_base_dir, output_dir=output_dir, dragon='tarnet',lr2  = lr , batchsize2 = batchsize)
